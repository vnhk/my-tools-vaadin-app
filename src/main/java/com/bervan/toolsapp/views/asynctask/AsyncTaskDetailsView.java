...
public class AsyncTaskDetailsView extends AbstractAsyncTaskDetails {
    public AsyncTaskDetailsView(BaseService<UUID, AsyncTask> service, BaseService<UUID, HistoryAsyncTask> historyService, BervanLogger bervanLogger, BervanViewConfig bervanViewConfig) {
        super(service, historyService, bervanLogger, bervanViewConfig);
    }
}
